...
func (t *TerragruntOptions) Clone(terragruntConfigPath string) *TerragruntOptions {
	workingDir := filepath.Dir(terragruntConfigPath)
	...
	return &TerragruntOptions{
		...
		Logger:                         util.CreateLogEntryWithWriter(t.ErrWriter, workingDir, t.LogLevel, t.Logger.Logger.Hooks),
		LogLevel:                       t.LogLevel,
		...
		IncludeModulePrefix:            t.IncludeModulePrefix,
